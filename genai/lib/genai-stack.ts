...
export class GenaiStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // });
    const myKmsKey = new kms.Key(this, 'myKMSKey'); //aws_kms

    const myBucket = new s3.Bucket(this, 'Bucket', {   //aws_bucket
    ...
    //const subnet = ec2.Subnet.fromSubnetId(this, 'ExistingSubnet', 'subnet-06d539a9e99e91765');
